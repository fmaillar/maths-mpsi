...
\subsection{Ensemble $(\R^X, \leq)$ partiellement ordonné}
...
\begin{proof}
  ...
  \item sinon, on a $\lambda > 0$ et
    ...
    \end{equation}
%on sait que $\sup\limits_{X}\frac{1}{\lambda} \lambda f \leq \frac{1}{\lambda} \sup\limits_{X}\lambda f$. 
...
\begin{proof}
  ...
  \begin{gather}
    0 \leq f(x) \leq \sup\limits_{X}f, \\
    0 \leq g(x) \leq \sup\limits_{X}g.
  \end{gather}
  Donc en multipliant les inégalités
  \begin{equation}
    0 \leq f(x)g(x) \leq (\sup\limits_{X}f)(\sup\limits_{X}g).
  \end{equation}
...
\begin{proof}
  ...
  \item Dans le cas où $c$ est à l'intérieur de $I$. On a
    \begin{equation}
      \ell_1 = \lim\limits_{c^{-}}f \leq f(c) \leq \ell_2 = \lim\limits_{c^{+}}f.
    \end{equation}
    Dire que $f$ n'est pas continue en $c$ revient à dire que l'une des deux au moins de ces inégalités est stricte. Supposons que c'est la première $\ell_1 < f(c)$ et $\ell_1 = \lim\limits_{c^{-}}f = \sup\limits_{x < c} f(x)$. Soient $b \in I$ tel que $b < c$, alors $f(b) \leq l_1$. Soit $y \in \intervalleoo{\ell_1}{f(c)} \subset \intervalleoo{f(b)}{f(c)}$. Alors on a
    \begin{itemize}
    ...
    \item si $x \geq c$ alors $f(x) \geq f(c)$ (car $f$ est croissante).
    \end{itemize}
