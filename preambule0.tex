...
%%%%%%%%%%%%%%%%%%%%%%%% COMMANDES PERSOS %%%%%%%%%%%%%%%
\newcommand{\fonction}[5]{#1\colon\left\{\begin{array}{ccc}#2 & \longrightarrow &#3\\#4 & \longmapsto & #5\end{array}\right.} % chktex 21
...
\newcommand{\intervalleff}[2]{\ensuremath{\left[ #1 \pv{} #2 \right]}} % chktex 9;10;15
\newcommand{\intervalleof}[2]{\ensuremath{\left] #1 \pv{} #2 \right]}} % chktex 9;10;15
\newcommand{\intervallefo}[2]{\ensuremath{\left[ #1 \pv{} #2 \right[}} % chktex 9;10;15
\newcommand{\intervalleoo}[2]{\ensuremath{\left] #1 \pv{} #2 \right[}} % chktex 9;10;15
\newcommand{\intervalleentier}[2]{\intervalle\llbracket{#1}{#2}\rrbracket}
\newcommand{\R}{\ensemblenombre{R}}
\newcommand{\Rplus}{\R_{+}}%{\intervallefo{0}{+\infty}}
\newcommand{\Rmoins}{\R_{-}}%{\intervalleof{-\infty}{0}}
\newcommand{\Rplusetoile}{\Rplus^{*}}%{\intervalleoo{0}{+\infty}}
\newcommand{\Rmoinsetoile}{\Rmoins^{*}}%{\intervalleoo{-\infty}{0}}
...
\newcounter{corrige}
\counterwithin*{corrige}{chapter}
\newenvironment{corrige}[1][]{%
\stepcounter{corrige}%
\par\vspace{5pt}\noindent
\fbox{\textbf{Corrigé~\thechapter.\thecorrige~\textit{#1}}}%
\hrulefill\par\vspace{10pt}\noindent\rmfamily}%
{\par\noindent\hrulefill\vrule width10pt height2pt depth2pt\par}
\numberwithin{equation}{section}
%%%%%%%%%%%% CREATE A SHADOW EQUATION ENV %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  \begin{empheq}[box = \shadowbox*]{equation}
%    \ln x = \int_{1}^{x} \frac{\diff t}{t}.
%  \end{empheq}
%\newenvironment{shadoweq}{\begin{empheq}[box = \shadowbox*]{equation}}{\end{empheq}}
