...
\end{empheq}
Le diagramme de Venn correspondant est donné par la figure~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:comp}.
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw \En; 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:inter}.
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw \En; 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:reunion}.
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw \En; 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:diff}.
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw \En; 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:diffsym}.
\begin{figure}
    \centering
    \begin{tikzpicture}
        \draw \En; 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:application}. Soit une application \(f=(E,F,\Gamma)\), 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:compose}.
\begin{figure}
    \centering
    \begin{tikzpicture}[roundnode/.style={circle},]
        ...
        \path[->] (ensembleE.east) edge[bend left=25] node[pos=0.5,above] {\(f\)} 
            (ensembleF.west);
        \path[->] (ensembleF.east) edge[bend right=25] node[pos=0.5,below] {\(g\)} 
            (ensembleG.west);
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:inj} donne une représentation graphique de la notion 
    d'injection.
\end{defdef}
\begin{theo}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:surj} donne une représentation graphique de la 
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap3-fig:bij} donne une représentation graphique de la 
    notion de bijection.
\end{defdef}
