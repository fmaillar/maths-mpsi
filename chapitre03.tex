\chapter{Théorie des ensembles et des applications}\label{chap:ensembles}
\minitoc%
\minilof%
\minilot%
...
\subsubsection{Complémentaire de \(A\) dans \(E\)}\label{chap3-subsubsec:complementaire}
...
\subsubsection{Intersection des parties \(A\) et \(B\)}\label{chap3-subsubsec:intersection}
...
\subsubsection{Différence de A et B}\label{chap3-subsubsec:difference}
...
\begin{figure}[p]
  ...
  \end{tikzpicture}
  \caption{Représentation de la différence \(A \setminus B\)}\label{chap3-fig:diff}
\end{figure}

\subsubsection{Différence symétrique de \(A\) et \(B\)}\label{chap3-subsubsec:differencesymetrique}
...
\begin{figure}[t]
  ...
  \end{tikzpicture}
  \caption{Représentation de la différence symétrique \(A \Delta B\)}\label{chap3-fig:diffsym}
\end{figure}
...
\subsection{Ensemble vide}\label{chap3-subsec:ensemblevide}
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Représentation de la notion d'application}\label{chap3-fig:application}
\end{figure}

\subsection{Restriction et prolongement}\label{chap3-restrictionetprolongement}

\subsubsection{Restriction au départ}\label{chap3-subsubsec:restrictiondep}
...
\subsubsection{Prolongement à l'arrivée}\label{chap3-subsubsec:prolongementarr}
...
\subsection{Injection et surjection}\label{chap3-subsec:injetsurj}
...
\begin{figure}
  \begin{tikzpicture}[label distance = 1mm]
    ...
    \node[fill = white] at (0,-0.8) {$f$};
  \end{tikzpicture}
  \caption[Injection]{Représentation graphique d'une injection}\label{chap3-fig:inj}
\end{figure}

\subsubsection{Surjection}\label{chap3-subsubsec:surjection}
...
\begin{figure}
  ...
  \begin{tikzpicture}[label distance = 1mm]
    ...
    \node[fill = white] at (-1,-0.4) {$f$};
  \end{tikzpicture}
  \caption[Surjection]{Représentation graphique d'une surjection}\label{chap3-fig:surj}
\end{figure}

\subsection{Bijection}\label{chap3-subsubsec:bijection}
...
\begin{figure}
  \begin{tikzpicture}[label distance = 1mm]
    ...
    % \node[fill = white] at (-1,-0.4) {$f$};
  \end{tikzpicture}
  \caption[Bijection]{Représentation graphique d'une bijection}\label{chap3-fig:bij}
\end{figure}
...
\section{Familles}\label{chap3-sec:familles}
...
\subsubsection{Formulaire}\label{chap3-subsubsec:formulaireensemble}
