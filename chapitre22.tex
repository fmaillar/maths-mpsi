...
\begin{proof}
  ...
  Soient ensuite deux matrices \(A\) et \(B\) diagonales et on note \(C=AB\). Pour tous \(i\) et \(j\) dans \(\intervalleentier{1}{n}\) on a
  \begin{equation}
    \begin{cases}
  ...
  Soient ensuite deux matrices \(A\) et \(B\) triangulaire supérieures et on note \(C=AB\). Pour tous \(i\) et \(j\) dans \(\intervalleentier{1}{n}\) on a si \(i > j\)
  \begin{equation}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:caracrangbase}). On peut donc compléter cette famille en une base \(\F=(f_1, \ldots, f_r,f_{r+1}, \ldots, f_n)\). Alors pour tout \(i \in \intervalleentier{1}{r}\) \(u(e_i)=f_i\), et pour tout \(i \in \intervalleentier{r+1}{p}\) \(u(e_i)=0\). Donc \(\Mat_{\E,\F}(u) = J_{n,p,r}\).
