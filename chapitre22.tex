...
\begin{proof}
  ...
  (voir proposition~\ref{prop:caracrangbase}). On peut donc compléter cette famille en une 
...
\end{proof}
\section{Exercices}
\begin{exercice}[Addition et multiplication de matrices]
...
\begin{exercice}[Matrice transposée]
...
\begin{exercice}[Matrice symétrique et antisymétrique]
...
\begin{exercice}[Inversibilité d'une matrice]
...
\begin{exercice}[Produit d'une matrice par un vecteur]
...
\begin{exercice}[Calcul du rang d'une matrice]
...
\begin{exercice}[Matrice de passage]
...
\begin{exercice}[Formule du changement de base]
...
\begin{exercice}[Rang de la matrice transposée]
...
\begin{exercice}[Sous-anneau des matrices diagonales]
