...
\begin{prop}
  $\Dr_n(\K)$, $T_n^s(\K)$ et $T_n^i(\K)$ sont des sous anneaux de $\Mn{n}{\K}$. De plus $\Dr_n(\K)$ est commutatif, $T_n^s(\K)$ et $T_n^i(\K)$ ne sont ni commutatifs ni intègre (si $n \geq 2$).
\end{prop}
\begin{proof}
