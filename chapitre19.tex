...
\end{align*}
\section{Exercices}
\begin{exercice}[Notion de fraction rationnelle]
...
\begin{exercice}[Fraction rationnelle dérivée]
...
\begin{exercice}[Degré d’une fonction rationnelle]
...
\begin{exercice}[Racines et pôles d’une fraction rationnelle]
...
\begin{exercice}[Représentants irréductibles d’une fraction rationnelle]
...
\begin{exercice}[Fonction rationnelle associée à une fraction rationnelle]
...
\begin{exercice}[Composition de fractions rationnelles]
...
\begin{exercice}[Partie entière d’une fraction rationnelle]
...
\begin{exercice}[Décomposition en éléments simples]
...
\begin{exercice}[Pratique de la décomposition en éléments simples]
