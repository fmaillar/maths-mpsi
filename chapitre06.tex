...
\begin{defdef}
 On dit que l'arc \((I,f)\) est régulier en \(t_0\) (ou encore \(M_0\) est un point régulier) si \(\derived{\vect{OM}}{t}(t_0) \neq 0\), alors la courbe \(\Gamma\) admet une tangente au point \(M_0\) dirigée par le vecteur \(\derived{\vect{OM}}{t}(t_0)\).% La figure~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:pointreg} illustre cette propriété.
\end{defdef}
\begin{defdef}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{tab:sym}.
...
Le tableau de variation de cette courbe paramétrée est donnée par le tableau~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{tab:folium}.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:folium}.
\begin{figure}
 \centering
...
On sait que \(\theta(t)=\theta \quad \theta'(t)=1 \quad \theta''(t)=0\) alors si \(r\) est deux fois dérivable, en appliquant la formule de la section~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{subsec:not} on arrive à
\begin{align}
...
On cherche de nouveau à réduire l'intervalle d'étude. Une liste non-exhaustive de transformation est donnée dans la table~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{tab:sympol}.
\begin{table}
  \centering
  \begin{tabular}{|c|c|}\hline
...
Le tableau de variations est donnée par le tableau
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{tab:gamma}.
...
On trace cette courbe paramétrée sur la figure~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:pol}.
\begin{figure}
 \centering
