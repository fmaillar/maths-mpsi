...
\(\B\) de \(E_2\), \(\Mat_\B(r) = \begin{bmatrix} \cos\theta & -\sin\theta 
\\ \sin\theta & \cos\theta \end{bmatrix}\). Soit \(a\) un vecteur unitaire 
quelconque. On peut compléter \(a\) en une base orthonormée directe 
\((a,b)\). Comme on a
\begin{gather}
  \Mat_{(a,b)}(r)=\begin{bmatrix} \cos \theta & -\sin \theta \\ \sin\theta & 
