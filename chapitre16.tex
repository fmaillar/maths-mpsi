...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:groupes} au théorème~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:uinversible} à la page~\pageref{theo:uinversible} que c'est un groupe.
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:caracSommeDirecte} c'est équivalent à \(E_1 \cap E_2 =\{0\}\).
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:fonctionsusuelles} que
\begin{equation}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:dimensionfinie} et en dimension infinie c'est une conséquence de l'axiome du choix. Cependant, il n'y a pas unicité du supplémentaire.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{sec:projections}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:rang}.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:caracSommeDirecte}). Alors on peut définir les applications \(\fonction{p_1}{E}{E_1}{x}{x_1}\) et \(\fonction{p_2}{E}{E_2}{x}{x_2}\). L'application \(p_1\) est appelée la projection sur \(E_1\) parallèlement à \(E_2\). De manière analogue, l'application \(p_2\) est appelée la projection sur \(E_2\) parallèlement à \(E_1\).
\end{defdef}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:deuxsuppiso}]
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:preptheorang}, comme \(p'_2\) est linéaire tout supplémentaire de \(\Ker(p'_2)\) est isomorphe à \(\Image(p'_2)\). C'est-à-dire en remplaçant que \(\varphi\) est un isomorphisme de \(E_2\) sur \(E'_2\).
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:caracimageproj} pour tout \(x \in \Image(p)\) \(p(x)=x\).
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{theo:propprojection} au point 4.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:projecteursupplementaire}). Alors \(p\) est la projection sur \(\Image(p)\) parallèlement à \(\Ker(p)\).
  \end{enumerate}
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{sec:projections} on sait que \(q=\Id-p\) est la projection sur \(E_2\) parallèlement à \(E_1\) et les égalités en découlent.
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{subsec:exemples}.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:projecteursupplementaire}).
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{lemme:affinites} et de la définition~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{def:affinites}, \(a_{\alpha}=p_1+\alpha p_2\).
\end{prop}
\begin{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:polynomes}.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:associativitevec} pour \(y_0=-x_0\).
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:associativitevec} peut se reformuler ainsi~: \(T\) est un morphisme du groupe \((E,+)\) sur le groupe \((\sigma(E),\circ)\). On note \(T(E)=\Image(T)\).
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:interssaffines}, \(W_1 \cap W_2\) est un sous-espace affine et \(W_1 \cap W_2 = I+E_1 \cap E_2 = I+\{0\}=\{I\}\).
\end{proof}
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:reels}.
\end{enumerate}
