...
\end{enumerate}
\section{Exercices}
\begin{exercice}[Sous-espaces vectoriels et dimension]
...
\end{enumerate}
\end{exercice}
\begin{exercice}[Sous-espace vectoriel associé à une équation]
...
\end{enumerate}
\end{exercice}
\begin{exercice}[Critère d'indépendance linéaire]
...
\begin{exercice}[Théorème de la dimension : Application à l’espace affine]
...
\begin{exercice}[Formes linéaires]
...
\begin{exercice}[Application linéaire et son noyau]
...
\begin{exercice}[Espace vectoriel euclidien]
...
\begin{exercice}[Produit scalaire et applications]
...
\begin{exercice}[Intersection et somme de sous-espaces]
...
\begin{exercice}[Propriétés des endomorphismes]
