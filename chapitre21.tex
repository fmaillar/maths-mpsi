...
\begin{align}
  ...
  2n'' +1 \leq n \leq 2n''+3
\end{align}
$2n'$ est le plus grand entier pair inférieur à $n$ et $2n''+1$ est le plus grand entier impair inférieur à $n$. Alors la table~\ref{tab:MacLaurin} donne les développements.

\begin{table}[!h]
  \centering
  \begin{tabular}{|c|c|c|c|}\hline
    $f(x)$ &  $f^{(k)}(0), k\geq 1$ & $T_n(x)$ & $I$ \\ \hline
