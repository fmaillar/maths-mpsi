...
\end{defdef}
\section{Exercices}
\begin{exercice}[Notion de primitive]
Soit \( f(x) = 2x \).
\begin{enumerate}
...
\begin{exercice}[Calcul de primitives]
Soit \( f(x) = 3x^2 + 5x - 4 \).
\begin{enumerate}
    \item Trouver une primitive de \( f(x) \).
...
\begin{exercice}[Intégration par parties]
...
\begin{exercice}[Primitives des fonctions usuelles]
...
\begin{exercice}[Primitives d'une fonction polynomiale]
...
\begin{exercice}[Intégration par parties – exemple avec trigonométrie]
...
\begin{exercice}[Changement de variable avec un carré]
Soit \( f(x) = \sqrt{4 - x^2} \).
\begin{enumerate}
...
\begin{exercice}[Primitives des fonctions trigonométriques]
Calculer les primitives des fonctions suivantes :
\[
...
\begin{exercice}[Primitives d'exponentielles]
Soit \( f(x) = 5 e^{2x} \).
\begin{enumerate}
    \item Trouver une primitive de \( f(x) \).
    \item Vérifier le résultat en dérivant la fonction obtenue.
