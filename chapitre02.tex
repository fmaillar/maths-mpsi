...
\begin{prop}
  ...
  \begin{empheq}[box = \shadowbox*]{align}
    \U_n = \enstq{\expc{}{\frac{2 \pi k}{n}}}{k\in\intervalleentier{0}{n - 
    1}}.
  \end{empheq}
...
\begin{figure}
  ...
  %        \centering
  %        % include second image
  %        \includegraphics[scale = 0.33]{U_9.png}  
  %        \caption{$\U_9$}
  %        \label{fig:U9}      
  %    \end{subfigure}
  %    \begin{subfigure}{.3\textwidth}
  %        \centering
  %        % include second image
  %        \includegraphics[scale = 0.33]{U_10.png}  
  %        \caption{$\U_{10}$}
  %        \label{fig:U10}
  %    \end{subfigure}  
  %    \begin{subfigure}{.3\textwidth}
  %        \centering
  %        % include first image
  %        \includegraphics[scale = 0.33]{U_11.png}  
  %        \caption{$\U_{11}$}
  %        \label{fig:U11}
  %    \end{subfigure}
  %    \newline
  ...
  %        \centering
  %        % include second image
  %        \includegraphics[scale = 0.33]{U_12.png}  
  %        \caption{$\U_{12}$}
  %        \label{fig:U12}      
  %    \end{subfigure}
  %    \begin{subfigure}{.3\textwidth}
  %        \centering
  %        % include second image
  %        \includegraphics[scale = 0.33]{U_13.png}  
  %        \caption{$\U_{13}$}
  %        \label{fig:U13}      
  %    \end{subfigure}
  %    \begin{subfigure}{.3\textwidth}
  %        \centering
  %        % include second image
  %        \includegraphics[scale = 0.33]{U_14.png}  
  %        \caption{$\U_{14}$}
  %        \label{fig:U14}
  %    \end{subfigure}
