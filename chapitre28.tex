...
\end{cor}
\begin{proof}
  Soit $f$ une isométrie. On a vu qu'elle se décompose de manière unique en produit d'une translation $t$ et d'une application orthogonale $g$ (théorème \ref{theo:isometrietransorth}). Une translation est un produit de réflexions et $g$ est aussi un produit de réflexions (théorème \ref{theo:orthreflexions}).
\end{proof}
