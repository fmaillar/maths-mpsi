...
\begin{prop}
  ...
  % Par exemple on peut donner la tangente de la fonction \(f : x 
  % \longrightarrow \frac{1}{x} - \frac{x^2-2}{x-10}\) au point d'abcisse 
  % \(\sqrt{2}\) sur la figure~\ref{fig:derivee}. 
  % \begin{figure}
  %   \centering
