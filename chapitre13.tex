...
Soit $f$ une fonction polynomiale de $\R$ dans $\R$. Il existe deux entiers naturels $p, n$ avec $p \leq n$ et des réels $a_p, \ldots, a_n$ avec $a_p \neq 0$ et $a_n \neq 0$ tels que
\begin{equation}
...
\begin{theo}
  Soient $p$ et $n$ deux naturels tels que $p \leq n$. Si $f$ admet le $DL_n(a)$ suivant
  \begin{equation}
    f(x)=\sum_{k=0}^n \alpha_k (x-a)^k +\petitof{a}{(x-a)^n},
  \end{equation}
...
\begin{proof}
  ...
  \end{align}
  comme tous les entiers $k \geq p+1$ dans la deuxième somme alors 
  \begin{equation}
...
\begin{equation}
  f(x) = \sum_{k=0}^n \alpha_k (x-a)^k + \petitof{a}{(x-a)^n}.
\end{equation}
Alors $f(x) \sim_a \sum_{k=0}^n \alpha_k (x-a)^k$ en supposant qu'il existe $k \leq n-1$ tel que $\alpha_k \neq 0$ alors
\begin{equation}
