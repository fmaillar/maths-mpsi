...
D'après ce qui précéde, on a les équivalents en zéro des fonctions suivantes sur la table~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{tab:equiv}.
\begin{table}[!h]
  \centering
...
\begin{theo}[Formule de Taylor-Young]
  ...
  \end{equation}
\end{theo}
On l'admet pour l'instant, elle sera démontrée au chapitre~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:integration} sur l'intégration. On peut l'utiliser dès maintenant. Elle permet de trouver les développements limités de nombreuses fonctions.
