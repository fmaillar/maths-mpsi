...
Soit M sur $\Delta$ le point d'abcisse $x$. Le projeté orthogonal de M sur la directrice $\Dr$ est le point K, puisque $\Dr$ et $\Delta$ sont orthogonal et se croisent en K. On a alors la suite d'équivalence suivante~:
\begin{align}
