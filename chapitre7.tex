...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=0.5.png}  
      \caption{$p=0.5$}
      \label{fig:parabole1}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=0.75.png}  
      \caption{$p=0.75$}
      \label{fig:parabole2}
    \end{subfigure}
    \newline
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=1.png}  
      \caption{$p=1$}
      \label{fig:parabole3}
    \end{subfigure}    
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=1.5.png}  
      \caption{$p=1.5$}
      \label{fig:parabole4}
    \end{subfigure}
    \newline
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=1.75.png}  
      \caption{$p=1.75$}
      \label{fig:parabole5}
    \end{subfigure}
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=2.png}  
      \caption{$p=2$}
      \label{fig:parabole6}
    \end{subfigure}
    \newline
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=2.5.png}  
      \caption{$p=2.5$}
      \label{fig:parabole7}
    \end{subfigure}    
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_parabole_p=3.png}  
      \caption{$p=3$}
      \label{fig:parabole8}
    \end{subfigure}
%  \centering
...
On a représenté quatre hyperboles sur la figure~\ref{fig:hyperbole}.

\begin{figure}
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_hyperbole_e=1.5_p=1.png}  
      \caption{$e=1.5, p=1$}
    ...
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_hyperbole_e=1.5_p=3.png}  
      \caption{$e=1.5, p=3$}
    ...
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_hyperbole_e=1.12_p=0.5.png}  
      \caption{$e=\frac{\sqrt{5}}{2}, p=\frac{1}{2}$}
      \label{fig:hyperbole3}
    \end{subfigure}    
    \begin{subfigure}{.5\textwidth}
      \centering
      % include first image
      \includegraphics[scale=.45]{Tracé_hyperbole_e=1.73_p=1.png}  
      \caption{$e=\sqrt{3}, p=1$}
      \label{fig:hyperbole4}
    \end{subfigure}

%  \centering
%  \includegraphics[width=\textwidth]{./hyperbole.png}
  \caption{Représentation de quatre hyperboles}
  \label{fig:hyperbole}
\end{figure}
