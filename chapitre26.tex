...
\begin{theo}
  ...
  a été prouvé à la sous-section~
\ref{subsec:orthetsupp}). \end{theo}
...
\begin{proof}
  ...
  \ref{theo:theosuppdimfinie}) que \(F_1\) et \(F_2\) sont supplémentaires 
  ...
  F_1^\perp\), d'après le corollaire~
  \ref{corth:supportho}.
...
\begin{proof}
  ...
  \begin{align}
    ...
    &=\prodscal{\sum_{i=1}^na_{ij}b_i}{\sum_{l=1}^na_{lk}b_l} && \text{eq.} 
