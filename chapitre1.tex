...
\begin{empheq}[box=\shadowbox*]{align}
    \cos^2 x+\sin^2 x &=1;\\
    \sin \left(\frac{\pi}{2}-x\right)=\cos x&=\sin \left(\frac{\pi}{2}+x\right) & \sin(\pi+x) &= -\sin x \\    
    \cos \left(\frac{\pi}{2}-x\right)=\sin x&=-\cos\left(\frac{\pi}{2}+x\right) & \sin(\pi-x) &= \sin x\\
    \tan \left(\frac{\pi}{2}-y\right)=\cot y&=-\tan \left(\frac{\pi}{2}+y\right)& \cos(\pi+x) &= -\cos x \\
    \cot \left(\frac{\pi}{2}-z\right)=\tan z&=-\cot \left(\frac{\pi}{2}+z\right)& \cos(\pi-x) &= \cos x
\end{empheq}
%
\begin{figure}
  \centering
...
\end{proof}
%
\begin{prop}[Expression logarithmique] La fonction argument cosinus hyperbolique peut s'exprimer pour tout \(x>1\) par
\begin{empheq}[box=\shadowbox*]{equation}
