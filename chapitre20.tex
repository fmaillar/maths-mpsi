...
\begin{defdef}
  ...
  \begin{equation}
    \delta(\sigma)=\max_{0 \leq i \leq n-1}(a_{i+1}-a_i)
  \end{equation}
\end{defdef}
...
\begin{proof}
  ...
  \begin{equation}
    \begin{cases}
      \varphi \leq f \leq \psi \\
      \psi-\varphi \leq \tilde{\epsilon}.
    \end{cases}
  \end{equation}
  Alors $\varphi \in \E^{-}(f)$ et $\psi \in \E^{+}(f)$. D'où
  \begin{equation}
    \int_a^b \varphi \leq S \quad \int_a^b \psi \geq I.
  \end{equation}
  D'une part on a
  \begin{equation}
    \int_a^b \psi -\varphi \leq \int_a^b \tilde{\epsilon}=\epsilon(a-b)=\frac{I-S}{2}
  \end{equation}
  et d'autre part
  \begin{equation}
    \int_a^b \psi-\varphi = \int_a^b \psi - \int_a^b \varphi \geq I-S
  \end{equation}
  Finalement on a $I-S \geq \frac{I-S}{2}$ et comme $I>S$ on a $1 \leq \frac{1}{2}$. Ce qui est absurde. Donc $I=S$.
\end{proof}
...
\begin{theo}
  Pour toute fonction continue $f$ sur $\intervalleff{a}{b}$, si $f$ est non nulle et $f \geq 0$ alors $\int_a^b f >0$.
\end{theo}
\begin{proof}
  ...
  \begin{equation}
    ...
    \end{cases}.
  \end{equation}
  La fonction $\varphi$ est donc en escalier sur $\intervalleff{a}{b}$ et $\varphi \leq f$. Par conséquent
  \begin{equation}
    \int_a^b f \geq \int_a^b \varphi,
  \end{equation}
  et par définition
  \begin{equation}
...
\end{theo}
\begin{proof}
  Si $f$ est en escalier sur $\intervalleff{a}{b}$, soit $\sigma=(a_i)_{0 \leq i \leq n}$ une subdivision de $\intervalleff{a}{b}$ adaptée à $f$. Soit $(\lambda_i)_{0 \leq i \leq n}$ la famille des valeurs constantes de $f$ sur $\intervalleff{a}{b}$. Soit $\sigma_T = (a_i+T)_{0 \leq i \leq n}$ et c'est une subdivision de $\intervalleff{a+T}{b+T}$ adaptée à $f_T$. La fonction $f_T$ est en escalier et
  \begin{equation}
    \int_{a+T}^{b+T} f_T = \sum_{i=1}^n ((a_i+T)-(a_{i-1}+T))\lambda_i = \sum_{i=1}^n (a_i-a_{i-1})\lambda_i=\int_a^b f
  \end{equation}


  On suppose maintenant que $f$ est continue par morceaux sur $\intervalleff{a}{b}$. Soit $\sigma=(a_i)_{0 \leq i \leq n}$ une subdivision de $\intervalleff{a}{b}$ adaptée à $f$. Soit $\varphi \in \E^{-}(f)$, on dispose alors de la fonction $\varphi_T \in \E(\intervalleff{a+T}{b+T})$ telle que $\int_{a+T}^{b+T} \varphi_T = \int_a^b\varphi$. Alors
  \begin{equation}
    \varphi_T \leq f_T
  \end{equation}
  donc $\varphi_T \in \E^{-}(f)$ et alors
  \begin{equation}
   \int_a^b\varphi = \int_{a+T}^{b+T} \varphi_T \leq \int_{a+T}^{b+T} f_T.
  \end{equation}
  C'est vrai pour toute fonction $\varphi \in \E^{-}(f)$ donc $\int_{a+T}^{b+T} f_T$ est un majorant de $I^{-}(f)$ d'où
  \begin{equation}
    \int_{a+T}^{b+T} f_T \geq \sup I^{-}(f) = \int_a^b f.
  \end{equation}
...
\begin{theo}
  Soient $(f,g) \in \CM(\intervalleff{a}{b})^2$ et $(m,M)\in \R^2$ tels que $\tilde{m} \leq f \leq \tilde{M}$. Si $g \geq \tilde{0}$ alors
  \begin{equation}
...
\begin{proof}
  Pour tout réel $x \in \intervalleff{a}{b}$, on a$ \begin{cases} m \leq f(x) \leq M \\ 0 \leq g(x) \end{cases}$. Donc
  \begin{equation}
    mg(x) \leq f(x)g(x) \leq Mg(x),
  \end{equation}
  par croissance de l'intégrale on a
  \begin{equation}
    \int_a^b mg \leq \int_a^b fg \leq \int_a^b Mg,
  \end{equation}
  et par linéarité
  \begin{equation}
    m \int_a^b g \leq \int_a^b fg \leq M \int_a^b g.
...
\begin{theo}
   Pour toutes fonctions $f$ et $g$ continues par morceaux sur $\intervalleff{a}{b}$, on a
  \begin{equation}
   \sqrt{\int_a^b (f+g)^2} \leq \sqrt{\int_a^b f^2}+\sqrt{\int_a^b g^2} 
  \end{equation}
  C'est l'inégalité triangulaire $||f+g||_2 \leq ||f||_2 + ||g||_2$.
\end{theo}
\begin{proof}
  Pour toutes fonctions $f$ et $g$ continues par morceaux sur $\intervalleff{a}{b}$, on a
  \begin{align}
    \int_a^b (f+g)^2 & = \int_a^b f^2 + \int_a^b g^2 +2 \int_a^b fg \\
    &\leq \int_a^b f^2 + \int_a^b g^2 +2 \sqrt{\int_a^b f^2 \int_a^b g^2} \\
    &\leq \left(\sqrt{\int_a^b f^2}+\sqrt{\int_a^b g^2}\right)^2.
  \end{align}
  La première inégalité est issue de l'inégalité de Cauchy-Schwarz. Cependant $\sqrt{\int_a^b f^2}+\sqrt{\int_a^b g^2} \geq 0$ et $\int_a^b (f+g)^2 \geq 0$ alors en passant à la racine on a bien l'inégalité de Minkowski~:
  \begin{equation}
    \sqrt{\int_a^b (f+g)^2} \leq \sqrt{\int_a^b f^2}+\sqrt{\int_a^b g^2}.
  \end{equation}
\end{proof}
...
\begin{defdef}
  Soient deux réels $a, b$ ($a<b$), $\sigma=(a_i)_{0 \leq i \leq n}$ une subdivision de $\intervalleff{a}{b}$ ed $n+1$ points, une fonction $f \in \R^{\intervalleff{a}{b}}$ et $\alpha=(\alpha_i)_{0 \leq i \leq n-1}$ une famille de $n$ points de $\intervalleff{a}{b}$ telle que pour tout $i \in \intervalleentier{0}{n-1}$, $\alpha_i \in \intervalleff{a_i}{a_{i+1}}$. On définit
  \begin{equation}
...
\begin{theo}
  Soient trois réels $a\leq c \leq b$ et $f \in \C^{\intervalleff{a}{b}}$. Alors
  \begin{equation}
