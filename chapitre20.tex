...
\C^{\intervalleff{a}{b}}\)}.
\section{Exercices}
\begin{exercice}[Subdivision d’un segment]
...
\begin{exercice}[Fonctions en escalier]
...
\begin{exercice}[Fonctions continues par morceaux]
Soit \( f(x) \) définie par \( f(x) = \begin{cases}
...
\begin{exercice}[Approximation d’une fonction continue par morceaux par une fonction en escalier]
...
\begin{exercice}[Définition de l’intégrale d’une fonction en escalier]
...
\begin{exercice}[Propriétés de l’intégrale d’une fonction en escalier]
Soit \( f(x) = \begin{cases}
4 & \text{si } 0 \leq x < 2, \\
...
\begin{exercice}[Linéarité de l’intégrale]
...
\begin{exercice}[Positivité et croissance de l’intégrale]
Soit \( f(x) = \begin{cases}
...
\begin{exercice}[Additivité de l’intégrale]
...
\begin{exercice}[Invariance par translation]
Soit \( f(x) = \begin{cases}
