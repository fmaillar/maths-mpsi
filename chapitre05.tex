...
\begin{equation} Y_\lambda = \enstq{M \in \P}{\Det(\vu, \vect{AM}) = \lambda}.
\end{equation}
...
\begin{enumerate}
  \item Le vecteur \(\vv\) est défini par la propriété suivante~: pour tout 
    ...
    \begin{proof}
      ...
      le déterminant aussi, c'est bon. Sinon alors \begin{align}
        \vv\cdot\vw& = \norme{\vv}\norme{\vw}\cos(\vv , \vw)\\ & = 
  ...
  \item La méthode précédente permet d'obtenir une équation pour les droites 
    ...
    \begin{itemize}
      \item un point \(A\) de \(\Dr\) et un vecteur directeur de \(\Dr\)
        ...
        \end{equation}
      \item deux points \(A\) et \(B\) de \(\Dr\) \begin{equation}
...
\begin{proof} On ne démontre que le troisième point. \(\Dr\) est la droite 
