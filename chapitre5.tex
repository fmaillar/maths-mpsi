...
%    ymajorgrids=true,
%    xmajorgrids=true,
%    xmin=-6.968752533139557,
%    xmax=14.71003110311733,
%    ymin=-2.457130511352199,
%    ymax=6.586987036898721,
%    xtick={-6,-5,...,14},
%    ytick={-2,-1,...,6},]
%    \clip(-6.968752533139557,-2.457130511352199) rectangle (14.71003110311733,6.586987036898721);
%    \draw [shift={(0,0)},line width=2pt,fill=black,fill opacity=0.10000000149011612] (0,0) -- (0:0.5080964914747708) arc (0:30:0.5080964914747708) -- cycle;
%    \draw [shift={(0,0)},line width=2pt,color=ttttff,fill=ttttff,fill opacity=0.1] (0,0) -- (30:0.5080964914747708) arc (30:79.38923529018234:0.5080964914747708) -- cycle;
%    \draw[line width=0.8pt,fill=black,fill opacity=0.10000000149011612] (0.6559965050809156,2.5260686698259085) -- (0.6890745594355236,2.7026362146953864) -- (0.5125070145660457,2.7357142690499945) -- (0.4794289602114377,2.5591467241805166) -- cycle; 
%    \draw [line width=2pt] (3.464101615137755,2) circle (4cm);
%    \draw [line width=2pt] (0,0)-- (3.464101615137755,2);
%    \draw [line width=2pt] (1.6812411584214006,1.0880048938381786) -- (1.7828604567163548,0.9119951061618206);
%    \draw [line width=2pt] (3.464101615137755,2)-- (0.9588579204228753,5.118293448361032);
%    \draw [line width=2pt] (2.1322600697552647,3.49550144760182) -- (2.2906994658053645,3.6227920007592123);
%    \draw [line width=2pt] (0.4794289602114377,2.5591467241805166)-- (0.9588579204228753,5.118293448361032);
%    \draw [line width=2pt] (0.6114651814845561,3.815814490066632) -- (0.8112285547880238,3.7783909435984717);
%    \draw [line width=2pt] (0.6270583258462891,3.899049228943077) -- (0.8268216991497568,3.8616256824749167);
%    \draw [line width=2pt] (0,0)-- (0.4794289602114377,2.5591467241805166);
%    \draw [line width=2pt] (0.13203622127311815,1.2566677658861163) -- (0.33179959457658587,1.219244219417955);
%    \draw [line width=2pt] (0.14762936563485107,1.3399025047625621) -- (0.34739273893831885,1.3024789582944007);
%    \draw [line width=2pt,dotted] (3.464101615137755,2)-- (0.4794289602114377,2.5591467241805166);
%    \begin{scriptsize}
%        \draw [fill=rvwvcq] (3.464101615137755,2) circle (2.5pt);
%        \draw[color=rvwvcq] (4.073877881578795,2.3613178828002104) node {$\Omega$};
%        \draw [fill=wrwrwr] (0,0) circle (2.5pt);
%        \draw[color=wrwrwr] (0.12766179779140874,-0.2807838728685974) node {$O$};
%        \draw[color=black] (3.1423676472083817,5.613135428238744) node {$\mathcal{C}$};
%        \draw [fill=rvwvcq] (0.9588579204228753,5.118293448361032) circle (2.5pt);
%        \draw[color=rvwvcq] (1.0930451315934733,5.477643030512138) node {$M$};
%        \draw [fill=wrwrwr] (0.4794289602114377,2.5591467241805166) circle (2.5pt);
%        \draw[color=wrwrwr] (0.7543141372769594,2.9032874737066328) node {$H$};
%        \draw[color=black] (1.9229360676689322,0.9725208061025039) node {R};
%        \draw[color=black] (1.1946644298884275,0.31199536718530185) node {$\phi$};
%        \draw[color=ttttff] (1.4148395761941615,1.2604421512715407) node {$\theta - \phi$};
%    \end{scriptsize}
%    \end{axis}
%    \end{tikzpicture}
    \caption{Cercle}
