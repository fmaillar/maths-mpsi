...
\end{defdef}
Ainsi la donnée d'un repère cartésien de l'espace permet de définir une bijection entre \(\R^3\) et \(\E\). La représentation du repère cartésien est donné par la figure
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:repcart}.
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:repcyl}.
\begin{defdef}
...
On conserve les notations de la sous-section~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{subsec:coordcyl}. On sait que \(\vect{OM}=r\vu_\varphi+z\vk\), donc si on note \(\rho=OM\) on a \(\rho=\sqrt{r^2+z^2}\). Un représentation des coordonnées sphériques est donnée par la figure
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{fig:repsphere}
\begin{itemize}
...
\end{prop}
\begin{proof}
  La démonstration est donnée au chapitre~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{chap:geomplan}.
\end{proof}
\begin{prop}
...
\end{prop}
\begin{proof}
  De la même manière que pour la proposition~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:propalgprodsc}, la démonstration est la même qu'au chapitre~
ef
ef
ef
ef
...
\end{prop}
\begin{proof}
  Si on suppose dans un premier temps que \(\vu\) et \(\vv\) sont colinéaires et on prétend qu'il existe un réel \(\lambda\) tel que \(\vu=\lambda\vv\) et alors le premier terme de l'égalité est nul d'après la proposition~
ef
ef
ef
ef
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{prop:1} et le deuxième terme vaut \((\vu\cdot\vw)\vv-(\vv\cdot\vw)\vu=\lambda(\vu\cdot\vw)\vu-\lambda(\vu\cdot\vw)\vu=0\).
...
ef
ef
ef\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref\ref{sec:prodvec}, \(\bondtrois\) est (in)directe si et seulement si \(\vk=\pm\vi\wedge\vj\) donc si et seulement si \(\Det\bondtrois=(\vi\wedge\vj)\cdot\vk=\pm\norme{\vk}^2=\pm 1\). Il vaut un lorsque la base est directe.
\end{proof}
