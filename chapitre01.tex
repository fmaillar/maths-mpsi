...
\begin{proof}
  ...
  \begin{align*}
    ...
    \begin{defdef}
      ...
      \R\setminus\left\{\pi\Z \right\}\) par~: \begin{empheq}[box = 
        \shadowbox*]{equation}
        \tan x = \frac{\sin x}{\cos x} \quad \cotan z = \frac{\cos z}{\sin z} 
        \quad \csc x = \frac{1}{\cos x} \quad \sec z = \frac{1}{\sin x}
      \end{empheq}
    \end{defdef}
  ...
  \begin{empheq}[box = \shadowbox*]{align*}
    \cos^2 x+\sin^2 x & = 1;\\
    \sin \left(\frac{\pi}{2}-x\right) = \cos x& = \sin 
    \left(\frac{\pi}{2}+x\right) & \sin(\pi+x) &= -\sin x \\    \cos 
    \left(\frac{\pi}{2}-x\right) = \sin x& = -\cos\left(\frac{\pi}{2}+x\right) & 
    \sin(\pi-x) &= \sin x\\
    \tan \left(\frac{\pi}{2}-y\right) = \cot y& = -\tan 
    \left(\frac{\pi}{2}+y\right)& \cos(\pi+x) &= -\cos x \\
    \cot \left(\frac{\pi}{2}-z\right) = \tan z& = -\cot 
    \left(\frac{\pi}{2}+z\right)& \cos(\pi-x) &= \cos x
  \end{empheq}
...
\begin{defdef}[Congruence]
  Pour tout réels, \(x, y, z\), on dit que \(x\) est congru à \(y\) modulo \(z\) 
  et on écris~:
  \begin{equation}
...
\section{Fonctions circulaires réciproque}\label{sec:chap1-fonctionscircréciproques}
...
1\)} et cette bijection admet une réciproque appelée arcsinus notée \(\arcsin\).
\end{defdef}

\begin{prop}
  Pour tout \(x \in \intervalleff{-\frac{\pi}{2}}{\frac{\pi}{2}}\) et  pour tout 
  \(y \in \intervalleff{-1}{1}\)
  \begin{equation}
...
\begin{figure}
  ...
  \caption{Tracé de arctangente et de ses asymptotes}\label{fig:tracearctangente}
\end{figure}
...
\begin{proof}[Existence]
  ...
  \intervalleof{-\pi}{0}\).
  On a bien montré l'existence d'un réel \(\theta \in \intervalleof{-\pi}{\pi}\) 
  tel que \(x = \cos \theta\) et \(y = \sin \theta\).
\end{proof}
...
\subsection{Fonctions sinus et cosinus hyperbolique}\label{subsec:chap1-sinushetcosh}
...
\begin{figure}
  ...
  \caption{Tracé de fonctions hyperbolique \(\htan\) et \(\hcotan\)}\label{fig:tracetanhcoth}
\end{figure}

\subsection{Formulaire de trigonométrie hyperbolique}\label{subsec:chap1-formulairetrigohyp}

En théorie la seule formule exigible est \(\hcos^2-\hsin^2 = 1\) mais les autres 
existent, elles peuvent se retrouver à partir du formulaire de trigonométrie 
circulaire en remplaçant \(\cos\) par \(\hcos\) et \(\sin\) par \(\ii \hsin\).

\section{Fonctions hyperboliques réciproques}\label{sec:chap1-fonctionshyprec}

\subsection{Fonction argument sinus hyperbolique}\label{subsec:chap1-fonctionargsinh}
...
\begin{figure}
  ...
  \caption{Tracé de fonctions hyperbolique \(\hsin\) et \(\argsh\)}\label{fig:tracesinhargsh}
\end{figure}

\subsection{Fonction argument cosinus hyperbolique}\label{subsec:chap1-fonctionargcosh}
...
\begin{prop}[Expression logarithmique] La fonction argument cosinus hyperbolique 
  peut s'exprimer pour tout \(x>1\) par
  \begin{empheq}[box = \shadowbox*]{equation}
...
\begin{figure}
  ...
  \caption{Tracé de fonctions hyperbolique \(\hcos\) et \(\argch\)}\label{fig:tracecoshargcosh}
\end{figure}

\subsection{Fonction argument tangente hyperbolique}\label{subsec:chap1-fonctionargtanh}
...
\begin{proof}
  Pour tout réel \(x\) et tout réel \(y \in \intervalleoo{-1}{1}\) \[y = \htan x 
  = \frac{\e^{2x}-1}{\e^{2x}+1},\]
...
\begin{exercice}
  Déterminer pour tout réel \(a\) et tout naturel \(n\) une expression simple de 
  la somme~:
  \begin{equation}
